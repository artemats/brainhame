...
class SocialMedia {
    ...
    public static function GetSocialMediaSites_NiceNames() {
        return [
            'add.this'         => 'AddThis',
            'blogger'          => 'Blogger',
            'buffer'           => 'Buffer',
    ...
    public static function GetSocialMediaSites_WithShareLinks_OrderedByPopularity() {
        return [
            'google.bookmarks',
            'facebook',
            'reddit',
    ...
    public function GetSocialMediaSiteLinks_WithShareLinks( $args ) {
        ...
        $page_type = urlencode( $args['page_type'] );
        ...
        return [
            ...
            'facebook_dialog'  => "https://www.facebook.com/dialog/share?app_id={$app_id}&display={$page_type}&href={$url}&redirect_uri={$redirect_url}",
